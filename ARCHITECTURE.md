...
- Low-saturation Japanese elegant platforms and slopes: textured wood with dark grain lines, cracked stone with highlights, and cloud platforms with inner bubble rings. In the Sky segment, cloud platforms and slopes dynamically interpolate their fill, slide, stripe, and stroke border colors with the 4000px day/night cycle, appending glowing outline borders (Noon: golden stroke; Dusk: rose-pink stroke; Night: fluorescent blue stroke; Dawn: light silver stroke) to maintain jump readability.
...
- Interactive particles: launch dust, landing impact dust ring, speed trails, and material-specific collision debris (wood splinters, stone chips, light sparks). Particles with high velocity ($v_x^2 + v_y^2 \ge 0.04$) render as smooth motion streaks for speed juice. Meteors are randomly spawned using this streak particle system during the Sky's Night phase.
